...
export default function FinanceCategoriesPage() {
    ...
    const groups: Array<{ title: string; type: FinanceCategoryType }> = [{ title: 'Expense categories', type: 'expense' }, { title: 'Income categories', type: 'income' }];
        ...
        return <AppShell contentClassName="p-5 md:p-8"><div className="mx-auto max-w-7xl"><header className="pb-5"><h1>Categories</h1><p className="mt-1 text-sm text-text-muted">Categories make reporting and future automatic classification useful.</p></header>
