...
import {
    FINANCE_TRANSACTION_FILTER_KEYS,
...
export function FinanceTransactionsClient({
    ...
    const [transactions, setTransactions] = useState<FinanceTransactionView[]>(initialTransactions);
    ...
    const categoryFilterId = filters.categoryId;
    const dateFilter = filters.date;
    const hasUncategorisedFilter = filters.uncategorised;
            ...
            <div className="mx-auto max-w-7xl">
                <div className="space-y-5">
                    ...
                    <section className="border border-border-default bg-bg-surface">
                        {isNavigating && <span className="sr-only" role="status">Loading ledger...</span>}
                        ...
                        <div className="divide-y divide-border-default" aria-live="polite" aria-busy={isNavigating}>
                            ...
                            {!filteredTransactions.length && <p className="px-5 py-12 text-center text-sm text-text-muted">No transactions found.</p>}
                        </div>
                    </section>
                </div>
            </div>
