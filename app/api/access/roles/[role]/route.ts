...
import { ACCESS_MANAGER_ROLES, APP_ROLE_SLUGS, AppRoleSlug, MANAGED_MODULE_SLUGS } from '@/lib/rbac/constants';
...
export async function PUT(
    ...
    const roleSlug = normalizeRoleSlug(role) as AppRoleSlug;
    ...
    if (!APP_ROLE_SLUGS.includes(roleSlug) || roleSlug !== role) {
        return NextResponse.json(
