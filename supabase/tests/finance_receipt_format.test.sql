...
select public.finance_refresh_rule_suggestions();
select pg_temp.check_format((select count(*)=2 from public.finance_parser_templates where field_name='reference_number'),'identical configurations have separate identities per format');
